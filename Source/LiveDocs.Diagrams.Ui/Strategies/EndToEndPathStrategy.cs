namespace LiveDocs.Diagrams.Ui.Strategies
{
    ...
    using LiveDocs.Diagrams.Ui.Services;
    ...
    public class EndToEndPathStrategy : IPathTestStrategy<IState, ITransition>
    {
        ...
        public Test GetTest(Path<IState, ITransition> path, IEventPublisherFactory publisherFactory)
        {
